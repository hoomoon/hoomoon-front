    ...
    <div className="p-4 text-white relative max-w-6xl mx-auto">
      ...
      <div className="mb-10">
        ...
        <p className="text-gray-300 max-w-3xl">
          Nossa missão é garantir que você tenha a melhor experiência possível na plataforma. Se tiver qualquer dúvida,
          dificuldade ou precisar de orientação, nosso time de suporte está pronto para te atender com agilidade e
          atenção.
        </p>
      </div>
      ...
      <div className="mb-10 bg-zinc-900 p-6 rounded-xl">
        ...
        <p className="text-gray-300">
          Atendemos de segunda a sábado, das 8h às 20h. Durante esse período, você pode entrar em contato conosco via
          WhatsApp, chat ao vivo ou abrir um ticket. Caso esteja fora do horário, sua solicitação será respondida assim
          que possível.
        </p>
      </div>
